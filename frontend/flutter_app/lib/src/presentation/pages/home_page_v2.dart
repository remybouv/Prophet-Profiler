...
/// Homepage V2 avec boutons conditionnels
/// 
/// Features:
...
class HomePageV2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: const _HomePageV2View(),
    );
  }
}

class _HomePageV2View extends StatefulWidget {
  const _HomePageV2View();

  @override
  State<_HomePageV2View> createState() => _HomePageV2ViewState();
}

class _HomePageV2ViewState extends State<_HomePageV2View> {
  @override
  void initState() {
    super.initState();
    ...
    return Column(
      ...
      children: [
        ...
        if (state.hasActiveSession)
          ElevatedButton.icon(
            onPressed: () {
              developer.log('🎲 Navigation Session Active', name: 'HomePageV2');
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => ActiveSessionPage(
        ...
        OutlinedButton.icon(
          onPressed: () {
            developer.log('➕ Navigation Nouvelle Session', name: 'HomePageV2');
            Navigator.push(
              context,
  ...
  void _onNavigationSelected(int index) {
    developer.log('📱 Navigation vers index: $index', name: 'HomePageV2');
    switch (index) {
